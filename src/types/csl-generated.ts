/* eslint-disable */
/**
 * Vendored TypeScript types derived from the CSL JSON schema.
 * Prefer updating from the upstream schema over hand-editing this file.
 */
 ...
 */
export type HttpsResourceCitationstylesOrgSchemaV10InputJsonCslDataJson = {
  type:
    | "article"
    | "article-journal"
    | "article-magazine"
