---
title: "Comparing sector returns since the beginning of the Covid-19 pandemic"
date: "2023-01-19"
excerpt: "One sector made the lowest lows from pre-pandemic levels... and also the highest highs"
image: "https://substackcdn.com/image/fetch/$s_!qYei!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F61ee8dd3-2385-44b4-833b-3b553309c068_2880x1620.jpeg"
sourceUrl: "https://modelingmarkets.substack.com/p/comparing-sector-returns-since-the"
sourceId: "https://modelingmarkets.substack.com/p/comparing-sector-returns-since-the"
---
...
Dancho M, Vaughan D (2022). tidyquant: Tidy Quantitative Financial Analysis\_. R package version 1.0.6. [https://CRAN.R-project.org/package=tidyquant](https://CRAN.R-project.org/package=tidyquant).
