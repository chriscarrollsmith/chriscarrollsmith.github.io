---
title: "Refining my mental model of vectors and cosine similarity"
date: "2026-01-19"
excerpt: "My mental model was that token embeddings represent points in n-dimensional space, and distance between points represents semantic similarity. Turns out that's not quite right."
image: "/images/cosine-similarity-1.png"
---
